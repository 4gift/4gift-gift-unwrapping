class GiftUnwrapping {
    ...
    animationDurations = {
        "giftBoxSlideLeftAnimationDuration": 5,
        "envelopeEnlargingAnimationDuration": 3,
        "envelopeSlideLeftAnimationDuration": 3,
        "envelopeOpeningAnimationDuration": 1.5,
        "letterSlideUpAnimationDuration": 1.5,
        "messageShowingAnimationDuration": 6,
        "tissuePaperDisappearAnimationDuration": 1,
        "dustBagDisappearAnimationDuration": 1,
        "giftSlideDownAnimationDuration": 2,
        "finalTextAppearingAnimationDuration": 1
    }
    ...
    initialize(brandName, messages, enjoyTheGiftString, containerDiv, giftUrl) {
        this.preLoad(brandName);
        this.buildAnimation(brandName, messages, enjoyTheGiftString, containerDiv, giftUrl);
    }

    buildAnimation(brandName, messages, enjoyTheGiftString, containerDiv, giftUrl) {
        ...
        cssLink.href = sourceBrandizedPath + "-gift-unwrapping-0.8.5.min.css";
...
//        containerDiv.appendChild(exitButton);
        ...
        const letterSlideUpAnimationDelay = envelopeOpeningAnimationDelay + this.animationDurations.envelopeOpeningAnimationDuration -0.5;
        ...
        const restartButtonAppearingAnimationDelay = finalTextAppearingAnimationDelay + this.animationDurations.finalTextAppearingAnimationDuration;
