class GiftUnwrapping {
    ...
    imagesName = [
        ...
        "https://cdn.jsdelivr.net/gh/4gift/4gift-gift-unwrapping/assets/brand/powered_by_4gift_white.svg"
    ]
    images = [];
    loadedImages;
    loader;
    ...
    buildAnimation(brandName, messages, containerDiv, giftUrl) {
        ...
        cssLink.href = sourceBrandizedPath + "-gift-unwrapping-0.8.8.min.css";
