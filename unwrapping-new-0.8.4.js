class GiftUnwrapping {
    ...
    initialize(brandName, message, enjoyTheGiftString, containerDiv, exitAnimationCallback) {
        this.preLoad(brandName);
        this.buildAnimation(brandName, message, enjoyTheGiftString, containerDiv);
        console.log(exitAnimationCallback)
        this.exitAnimationCallback = exitAnimationCallback;
    }
